...
\structure{Other worth-noting ML(DL) packages:}
	...
	\item CNTK/DMTK (Microsoft): First released on April 2015
		...
		\end{itemize}
	\item Neon (Nervana \& Intel): First released on May 2015
	\item MXNet (DMLC): First released on Jan 2015
...
\begin{figure}[htbp] 
	\includegraphics[width=0.9\paperwidth]{figures/platforms.pdf} 
