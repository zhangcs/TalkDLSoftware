...
\item Fourth paradigm, big data, artificial intelligence, Internet of things, deep learning, ...
...
{\tiny
\begin{center}
{\color{red} https://www.slideshare.net/0xdata/transform-your-business-with-ai-deep-learning-and-machine-learning}
\end{center}
}
\end{frame}
...
\begin{frame}
  \MyLogo
  \frametitle{Comparison: Basic Information}  
...
\begin{frame}
  \MyLogo
  \frametitle{Comparison: Performance}  
