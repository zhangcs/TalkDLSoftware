...
\begin{frame}
  ...
  \begin{itemize}
	  	...
	  	\item Tensorboard: To run TensorBoard, use the following command: tensorboard --logdir=path/to/log-directory. Once TensorBoard is running, navigate your web browser to localhost:6006 to view the TensorBoard.
  \end{itemize}
